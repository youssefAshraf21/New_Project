            ...
            className='relative py-16 sm:py-20 px-10 sm:px-6 lg:px-8'>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center  mb-12 sm:mb-16 lg:mb-20 ">
                        <h2 className="text-5xl font-bold mb-4 sm:text-4xl md:text-5xl lg:text-6xl leading-13 md:leading-18 ">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-6">
                        {plans.map((plan: Plan, index: number) => (
                            <div 
                            key={index}
                            className={`relative bg-slate-900/50 backdrop-blur-sm border rounded-xl sm:rounded-2xl p-6 sm:p-7 overflow-visable group flex flex-col h-full transition-all duration-300 
                            ${plan.mostPopular ? "border-blue-500 shadow-2xl shadow-blue-500/20 lg:scale-105"
                                ...
                                <div className="text-center mb-6 sm:mb-8">
                                    ...
                                    <div className="flex items-baseline justify-center">
                                        ...
                                        <span className="text-gray-400 text-sm sm:text-base ml-1 sm:ml-2 ">/month</span>
                                    </div>
                                </div>
                                <ul className="space-y-3 md:space-y-4 mb-6 sm:mb-8 flex-row">
                                    {plan.features.map((feature: string, index: number) => (
                                        ...
                                        className="flex items-start space-x-2 sm:space-x-3">
                                            <div className="shrink-0 w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-blue-500/20 flex items-center justify-center mt-0.5">
                                                <FaCheck className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-blue-400"/>
                                            </div>
                    ...
                    <div className= "mt-8 sm:mt-12 text-center ">
                        <p className="text-gray-400 text-base ">
                            Need a Custom Plane?  
                            <a href="#" className="text-blue-400 hover:underline hover:text-blue-500 ml-1">
